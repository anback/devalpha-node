...
it(`${ORDER_PLACED} adds an order to the Map of orders`, () => {
  const order = {
    id: '0',
    identifier: 'MSFT',
...
it(`${ORDER_FILLED} removes an order from the map of orders if completely filled`, () => {
  const placedOrder = {
    id: '0',
    identifier: 'MSFT',
    quantity: new Decimal(100),
...
it(`${ORDER_FILLED} retains an order in the map of orders if partially filled`, () => {
  const placedOrder = {
    id: '0',
    identifier: 'MSFT',
    quantity: new Decimal(100),
...
it(`${ORDER_CANCELLED} removes an order from the map of orders`, () => {
  const order = {
    id: '0',
    identifier: 'MSFT',
    quantity: new Decimal(100),
...
it(`${ORDER_FILLED} throws error if we received more volume than we wanted to buy`, () => {
  const placedOrder = {
    id: '0',
    identifier: 'MSFT',
    quantity: new Decimal(100),
...
it(`${ORDER_FILLED} throws error if we received more volume than we wanted to sell`, () => {
  const placedOrder = {
    id: '0',
    identifier: 'MSFT',
    quantity: new Decimal(-100),
